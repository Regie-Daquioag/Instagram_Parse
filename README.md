...
Somethings that I wanted to improve was to make it look slightly more like instagram. I wanted to add the tabs on the bottom and add user pictures and the names on top of the posted image.
